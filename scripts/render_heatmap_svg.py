...
# ROW_T = 0.045
# CELL_DUR = 0.42
# ปรับตัวคูณเวลาให้ช้าลง (เพิ่มจาก 0.018 เป็น 0.040)
COL_T = 0.040   # คลื่นจากซ้ายไปขวาจะใช้เวลาประมาณ 2.1 วินาที
ROW_T = 0.060   # จังหวะตกจากบนลงล่างจะชัดขึ้น
CELL_DUR = 0.60 # แต่ละช่องจะค่อยๆ สไลด์ลงมานุ่มนวลขึ้น
...
def render(data, username="devSeksan"):
    days = data["days"]
...
if __name__ == "__main__":
    ...
    svg = render(data, username="devSeksan")
